		...
		<form action="join.do" method='post'>
			...
			<div class="form-group">
				<label for="exampleInputEmail1">아이디</label> <input type="text"
					name="id" value="${param.id }" class="form-control" id="exampleInputEmail1"
			...
			<div class="form-group">
				<label for="exampleInputEmail1">이름</label> <input type="text"
					name="name" value="${param.name }" class="form-control" id="exampleInputEmail1"
					aria-describedby="emailHelp"> <br />
			...
			<div class="form-group">
				<label for="exampleInputPassword1">확인</label> <input type="password"
